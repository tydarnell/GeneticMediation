...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/tydarnell/GeneticMediation.svg?branch=master)](https://travis-ci.com/tydarnell/GeneticMediation)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/tydarnell/GeneticMediation?branch=master&svg=true)](https://ci.appveyor.com/project/tydarnell/GeneticMediation)
[![Codecov test coverage](https://codecov.io/gh/tydarnell/GeneticMediation/branch/master/graph/badge.svg)](https://codecov.io/gh/tydarnell/GeneticMediation?branch=master)
<!-- badges: end -->
